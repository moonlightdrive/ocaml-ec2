...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6e69c53f80b13f7adeb4aa5e82c4810f) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Support for registering custom AMIs";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["EC2"; "EC2_t"];
                      lib_pack = false;
                      lib_internal_modules = ["Signature4"; "Monad"; "EC2_x"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "ec2";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "ami_tools", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "ami";
                      bs_compiled_object = Best;
                      ...
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [("ec2_certs/*.pem", None)];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                   ...
                   },
                   {
                      lib_modules = ["Bundle"];
                      lib_pack = false;
                      lib_internal_modules = ["S3"];
                      lib_findlib_parent = Some "ec2";
                      lib_findlib_name = Some "ami";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "describe_regions";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [FindlibPackage ("lwt", None); InternalLibrary "ec2"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "describe_regions.ml"});
               Executable
                 ({
                     cs_name = "custom_kernel";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "custom_kernel.ml"});
               Executable
                 ({
                     cs_name = "parsexml";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "parsexml.ml"});
               Test
                 ({
                     cs_name = "parsexml";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "NR}\149\031\207\030F{a\135\250\205\231\244`";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
