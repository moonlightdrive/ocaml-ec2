...
(* OASIS_START *)
(* DO NOT EDIT (digest: d35146457c4c548e401fd7c8c5434bc7) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("ezxmlm", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "parse_response.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\027\144b\254\241{\176m\220L\213p\027!\165\255";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
