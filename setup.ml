...
(* OASIS_START *)
(* DO NOT EDIT (digest: 17ae5e9522f17222ff0b8fd324527096) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Monad"; "EC2"; "EC2_t"];
                      lib_pack = false;
                      lib_internal_modules = ["Signature4"; "EC2_x"];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\182\232\172_U\030\144\1839\139[\192\007w\237\187";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
