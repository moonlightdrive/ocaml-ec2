...
(* OASIS_START *)
(* DO NOT EDIT (digest: d6e26f5dd7eb00469a687e0740dc6b8d) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Signature4"];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "mirage_kernel.ml"});
               Executable
                 ({
                     cs_name = "s3_get_object";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "s3_get_object.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "\026!\185A\148\248\213\191\216\015\136\177\231\225\238=";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
